...
CREATE TABLE NID_QA.dbo.sys_company (
	sys_id nvarchar(32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, -- mantido tamanho fixo para permitir PK e índices
	name nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	parent nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	federal_tax_id nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	active nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_created_on nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_created_by nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_updated_on nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	etl_hash nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE TABLE NID_QA.dbo.sys_user (
	sys_id nvarchar(32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, -- PK mantém tamanho por índice
	user_name nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	name nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	active nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	locked_out nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	web_service_access_only nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	last_login nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	last_login_time nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	failed_attempts nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	time_zone nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	date_format nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	time_format nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_created_on nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_created_by nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_updated_on nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_updated_by nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
-- NID_QA.dbo.cmdb_ci_network_link definition

-- DROP TABLE NID_QA.dbo.cmdb_ci_network_link;

CREATE TABLE NID_QA.dbo.cmdb_ci_network_link (
	sys_id nvarchar(32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	name nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_class_name nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_link_name nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_end_a nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_end_b nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_bandwidth nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_status nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_provider nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	u_type nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_created_on nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_created_by nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_updated_on nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	sys_updated_by nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	etl_updated_at datetime2 DEFAULT getdate() NULL,
	etl_hash nvarchar(MAX) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	CONSTRAINT PK__cmdb_ci_network_link PRIMARY KEY (sys_id)
);